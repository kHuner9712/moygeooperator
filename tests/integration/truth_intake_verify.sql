...
BEGIN
  ...
  SELECT count(*) INTO v_evidence FROM evidence_items WHERE client_id=v_cid;
  ...
  SELECT count(*) INTO v_missing FROM exceptions WHERE client_id=v_cid AND exception_type='CLIENT_DATA_REQUIRED' AND status='OPEN';
